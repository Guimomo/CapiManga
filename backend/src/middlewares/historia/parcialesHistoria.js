// Middleware para validación parcial de Historia (PATCH)
import { ResponseProvider } from "../../providers/ResponseProvider.js";
import { campos } from "./campos.js";

export function parcialesHistoria(req, res, next) {
  const errors = [];
  ...
  for (const campo of campos) {
    const { name, minLength, maxLength, type, enum: enumValues } = campo;
